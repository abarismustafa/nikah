            ...
            <div class="col-lg-10 col-xl-8 col-xxl-6 mx-auto">
              <div class="text-center section-title mb-5">
                ...
                <p class="fw-400 fs-16 opacity-60">
                  Every user registered on Nikah Mubarak is verified via photo
                  and mobile phone so you don’t have to worry how real or fake
                  anyone is..
                </p>
              </div>
            </div>
                        ...
                        <div className="overflow-hidden shadow-none mb-3 border-right">
                          <div className="card-body">
                            ...
                            <div className="text-center mb-3">
                              <a
                                href="https://demo.activeitzone.com/matrimonial/package-payment-methods/eyJpdiI6IlVSdEVNbmV1ek1iTFJIdm1pS0ludnc9PSIsInZhbHVlIjoid1QxQ1lBMi9NZUN4SjBDM1NOWkh4QT09IiwibWFjIjoiOWNkMDgyMDQzY2M5ZmYzNjA2YzdjZGEzNDc1ODg5N2MzZmI5ZTdjNjkzMjVlNjRjYTFmZTgzN2M4NGI2ZTYyNSIsInRhZyI6IiJ9"
                                type="submit"
                      ...
                      >
                        <div className="overflow-hidden shadow-none mb-3 border-right">
                          <div className="card-body">
                            ...
                            <div className="text-center mb-3">
                              <a
                                href="https://demo.activeitzone.com/matrimonial/package-payment-methods/eyJpdiI6IjdIZFM1TWdlbEVyS3cyalhCckp1OWc9PSIsInZhbHVlIjoiQUptYS9aaTVrY0ErL2Q5dlNQSE1BZz09IiwibWFjIjoiYjRkNjQ2NzZjNjYzZjBiOWU2OWE5ODYzMmJhY2M4ZGQ3ZWVlMDVhNWVmZjIzNTlkMjA5NmFlNTk4ZTFiMzJkZiIsInRhZyI6IiJ9"
                                type="submit"
                                className="btn btn-primary"
                                tabIndex={-1}
                              >
                      ...
                      >
                        <div className="overflow-hidden shadow-none mb-3 border-right">
                          <div className="card-body">
                            ...
                            <div className="text-center mb-3">
                              <a
                                href="https://demo.activeitzone.com/matrimonial/package-payment-methods/eyJpdiI6IjhLdWlnYTl0NldndnpUS1lvUGdCMHc9PSIsInZhbHVlIjoiSFhVdGJNYnJmbGl4SnBWaGlJNkxCUT09IiwibWFjIjoiNWY1MzdjZGFiN2ZmYTM0NTU3ZDJlNTkxNDhjNzJhM2M3NjBlODAyMDU1NTNhMWQ4OThjOGVkZDQwMGQ1MTNmYyIsInRhZyI6IiJ9"
                                type="submit"
                                className="btn btn-primary"
                                tabIndex={-1}
                              >
                      ...
                      >
                        <div className="overflow-hidden shadow-none mb-3 border-right">
                          <div className="card-body">
                            ...
                            <div className="text-center mb-3">
                              <a
                                href="https://demo.activeitzone.com/matrimonial/package-payment-methods/eyJpdiI6Img3b2J5dVVFTVlEZldhTDJlT0oxV0E9PSIsInZhbHVlIjoiT2Z6U3dObXZDWEZNc3RVRVYwbXlMQT09IiwibWFjIjoiZGIzODY3NDdlZTU0ZDA0MzkxM2QxNDE1OTZmOWUwYmVhNjM2YjBmNTAwMTg1OTI1ODM4YzVmZDc0N2RjOWUxZiIsInRhZyI6IiJ9"
                                type="submit"
                                className="btn btn-primary"
                                tabIndex={-1}
                              >
                      ...
                      >
                        <div className="overflow-hidden shadow-none mb-3 border-right">
                          <div className="card-body">
                            ...
                            <div className="text-center mb-3">
                              <a
                                href="https://demo.activeitzone.com/matrimonial/package-payment-methods/eyJpdiI6IkRvSVNqRzBCazRJYXdTVEFIRUlaR2c9PSIsInZhbHVlIjoiSFhhL21nY1VUM3loVVZXdXRqNzdCZz09IiwibWFjIjoiMmNlNWUxNzdlY2VhNzIwMDZlMzUwOWI5NjMwZmQ5ODA1MDY1NDIxMzcxNjZmNDZmZjE1NjBhMmUxZmY2MjgyMCIsInRhZyI6IiJ9"
                                type="submit"
                                className="btn btn-primary"
                                tabIndex={-1}
                              >
                      ...
                      >
                        <div className="overflow-hidden shadow-none mb-3 border-right">
                          <div className="card-body">
                            ...
                            <div className="text-center mb-3">
                              <a
                                href="https://demo.activeitzone.com/matrimonial/package-payment-methods/eyJpdiI6ImJwaUtPbVZCRUVDMWRBeExORjlRSnc9PSIsInZhbHVlIjoiT1BYV2VVYXJmUjJPYTZJT2lGaFVEZz09IiwibWFjIjoiZTEzNjYzYTNmMzIxNmZjMDVlODc0NDk2OWEyN2NhNjIwYTk2OWM1ODdlODhlZGFlMTZkNzg4NzRjYWYzY2ZhNCIsInRhZyI6IiJ9"
                                type="submit"
                                className="btn btn-primary"
                                tabIndex={-1}
                              >
